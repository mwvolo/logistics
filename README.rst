...
Logistics management software for tracking freight and auto transportation.
...
To run the tests, enter the logistics/tests directory and run the following commands::
